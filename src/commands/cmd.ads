...
private
   ...
   type Cldata is
      record
         ...
         annot_action         : An_Annotate_Action := no_annotate_action;
         annot_tag_name       : Text;
         ...
         check_action         : A_Check_Action := unset_action;
         ...
         search_label         : A_Search_Field;
         search_field         : A_Search_Field;
         search_modifiers     : Set_Search_Modifiers;

         set_automatic_flag   : Three_State_Flag := undefined_flag;
         set_vital_flag       : Three_State_Flag := undefined_flag;
         set_name_pair        : Text;

         shlib_behavior       : Shared_Library := undefined_shlib;

         stats_behavior       : Database_Statistics := no_database_stats;
