...
# https://github.com/freebsd/ravensw/issues/1425
#ravenswA
# - ravenswB
#    - ravenswC
#      - ravenswD
...
${JAILED}[1/2] Reinstalling ravenswD-1.0...
${JAILED}[1/2] Extracting ravenswD-1.0:  done
${JAILED}[2/2] Reinstalling ravenswA-1.0...
${JAILED}[2/2] Extracting ravenswA-1.0:  done
"
        ...
        atf_check \
                ...
                -e empty \
                -s exit:0 \
                ravensw -o REPOS_DIR="${TMPDIR}" -o RAVENSW_CACHEDIR="${TMPDIR}" upgrade -yf ravenswA ravenswD


	rm -f ${TMPDIR}/local.sqlite


OUTPUT_CASE3="Updating repoA repository catalog...
repoA repository is up to date.
Updating repoB repository catalog...
repoB repository is up to date.
All repositories are up to date.
