...
ravensw_puppet_body() {
	...
	atf_check -s exit:0 sh ${RESOURCEDIR}/test_subr.sh new_manifest rubygemrubyaugeas rubygem-ruby-augeas 1.0
...
EOF
	...
	atf_check -s exit:0 sh ${RESOURCEDIR}/test_subr.sh new_manifest puppet puppet 1.0
	cat << EOF >> puppet.ucl
deps: {
	ruby: {
		origin: "lang/ruby20",
...
EOF
	...
	atf_check -s exit:0 sh ${RESOURCEDIR}/test_subr.sh new_manifest ruby ruby 2.0
	cat << EOF >> ruby.ucl
shlibs_provided [
	"libruby20.so.20",
]
...
EOF
	...
	atf_check -s exit:0 sh ${RESOURCEDIR}/test_subr.sh new_manifest rubygem-hiera rubygem-hiera 1.0
...
EOF
	...
	atf_check -s exit:0 sh ${RESOURCEDIR}/test_subr.sh new_manifest ruby-gems20 ruby20-gems 1.0
...
#### NEW
	...
	atf_check -s exit:0 sh ${RESOURCEDIR}/test_subr.sh new_manifest rubygemrubyaugeas.new rubygem-ruby-augeas 1.0
...
EOF
	...
	atf_check -s exit:0 sh ${RESOURCEDIR}/test_subr.sh new_manifest puppet.new puppet 1.0
...
EOF
	...
	atf_check -s exit:0 sh ${RESOURCEDIR}/test_subr.sh new_manifest ruby.new ruby 2.1
...
EOF
	...
	atf_check -s exit:0 sh ${RESOURCEDIR}/test_subr.sh new_manifest rubygem-hiera.new rubygem-hiera 1.0
...
EOF
	...
	atf_check -s exit:0 sh ${RESOURCEDIR}/test_subr.sh new_manifest ruby-gems21.new ruby21-gems 1.0
